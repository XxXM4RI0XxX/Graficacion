...
# Captura de video desde la cámara (Fuente de donde se toma)
cap = cv2.VideoCapture(0)
#En Windows el acceso a la camara tarda siglos xd

# Permitir que la cámara se estabilice (Tiempo de espera)
cv2.waitKey(2000)

# Capturar el fondo durante unos segundos
ret, background = cap.read()
# El metodo cap.read() regresa dos valores
# ret: Es un booleano que indica si
